...
RESOURCES += src/qt/ittrium.qrc src/qt/ittrium_locale.qrc

TRANSLATIONS += src/qt/locale/ittrium_bg.ts \
                src/qt/locale/ittrium_de.ts \
                src/qt/locale/ittrium_en.ts \
                src/qt/locale/ittrium_es.ts \
                src/qt/locale/ittrium_fi.ts \
                src/qt/locale/ittrium_fr.ts \
                src/qt/locale/ittrium_it.ts \
                src/qt/locale/ittrium_ja.ts \
                src/qt/locale/ittrium_pl.ts \
                src/qt/locale/ittrium_pt.ts \
                src/qt/locale/ittrium_ru.ts \
                src/qt/locale/ittrium_sk.ts \
                src/qt/locale/ittrium_sv.ts \
                src/qt/locale/ittrium_vi.ts \
                src/qt/locale/ittrium_zh_CN.ts \
                src/qt/locale/ittrium_zh_TW.ts
