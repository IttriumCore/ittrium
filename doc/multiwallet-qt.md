...
In order to support loading of multiple wallets in ittrium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ittrium.cpp.
...
Changes to ittrium.cpp
----------------------
ittrium.cpp is the entry point into ittrium-qt, and as such, will require some minor modifications to provide hooks for
