...
2. [Sending 5,000 Ittrium to new wallet addresses.](#option2)
...
### Send 5,000 Ittrium to New Addresses

Just like setting up a standard MN. Send exactly 5,000 Ittrium to each new address created above.
...
*Please note, the masternode priviate key is not the same as a wallet private key. Never put your wallet private key in the masternode.conf file. That is equivalent to putting your 5,000 Ittrium on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the ittrium github repo](https://github.com/IttriumCore/ittrium/blob/master/doc/masternode_conf.md)
...
If you are using a masternode.conf file you no longer need the ittrium.conf file. The exception is if you need custom settings (thanks oblox). 

## Update ittrium.conf on server

If you generated a new masternode private key, you will need to update the remote ittrium.conf files.

Shut down the daemon and then edit the file.

```sudo nano .ittrium/ittrium.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the masternodeprivkey value in your remote ittrium.conf file.
