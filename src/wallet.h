...
// Possible states for zXIT send
enum ZerocoinSpendStatus {
    ZXIT_SPEND_OKAY = 0,                            // No error
    ZXIT_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZXIT_WALLET_LOCKED = 2,                         // Wallet was locked
    ZXIT_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZXIT_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZXIT_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZXIT_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZXIT_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZXIT_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZXIT_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZXIT_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZXIT_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZXIT_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZXIT_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZXIT_SPENT_USED_ZXIT = 14,                      // Coin has already been spend
    ZXIT_TX_TOO_LARGE = 15                          // The transaction is larger than the max tx size
};
...
public:
    ...
    */
    ...
    void setZXITAutoBackups(bool fEnabled)
    {
