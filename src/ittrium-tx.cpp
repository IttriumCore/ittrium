...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ittrium Core ittrium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ittrium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ittrium transaction") + "\n" +
                               "  ittrium-tx [options] -create [commands]   " + _("Create hex-encoded ittrium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ittrium transaction
