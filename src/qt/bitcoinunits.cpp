...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(XIT);
    unitlist.append(mXIT);
    unitlist.append(uXIT);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case XIT:
            return QString("tXIT");
        case mXIT:
            return QString("mtXIT");
        case uXIT:
            return QString::fromUtf8("μtXIT");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case XIT:
            return QString("XIT");
        case mXIT:
            return QString("Milli-XIT (1 / 1" THIN_SP_UTF8 "000)");
        case uXIT:
            return QString("Micro-XIT (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case XIT:
            return QString("TestXITs");
        case mXIT:
            return QString("Milli-TestXIT (1 / 1" THIN_SP_UTF8 "000)");
        case uXIT:
            return QString("Micro-TestXIT (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
