...
/** Utility functions used by the Ittrium Qt UI.
 */
namespace GUIUtil
{
...
// Render Ittrium addresses in monospace font
...
// Parse "ittrium:" URI into recipient object, return true on successful parsing
