 ...
 */
    ...
    typeWidget->addItem(tr("Received XIT from zXIT"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zXIT"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zXIT));
