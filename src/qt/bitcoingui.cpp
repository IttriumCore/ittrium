                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ittrium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ittrium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ittrium: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXIT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ittrium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ittrium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ittrium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ittrium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ittrium addresses"));
    ...
    openAction->setStatusTip(tr("Open a Ittrium: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Ittrium Core help message to get a list with possible Ittrium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Ittrium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ittrium network", "", count));
}
...
{
    QString strTitle = tr("Ittrium Core"); // default title
