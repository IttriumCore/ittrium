...
CAmount AmountFromValue(const Value& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 33000000.0)
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Ittrium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ittrium features */
        {"ittrium", "masternode", &masternode, true, true, false},
        {"ittrium", "listmasternodes", &listmasternodes, true, true, false},
        {"ittrium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ittrium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ittrium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ittrium", "masternodedebug", &masternodedebug, true, true, false},
        {"ittrium", "startmasternode", &startmasternode, true, true, false},
        {"ittrium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ittrium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ittrium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ittrium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ittrium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ittrium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ittrium", "mnbudget", &mnbudget, true, true, false},
        {"ittrium", "preparebudget", &preparebudget, true, true, false},
        {"ittrium", "submitbudget", &submitbudget, true, true, false},
        {"ittrium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ittrium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ittrium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ittrium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ittrium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ittrium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ittrium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ittrium", "checkbudgets", &checkbudgets, true, true, false},
        {"ittrium", "mnsync", &mnsync, true, true, false},
        {"ittrium", "spork", &spork, true, true, false},
        {"ittrium", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ittrium", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ittriumd, or the -server option to ittrium-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ittrium-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:50369/\n";
}
