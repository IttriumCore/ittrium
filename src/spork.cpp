...
// Ittrium: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_18_NEW_PROTOCOL_DYNAMIC) r = SPORK_18_NEW_PROTOCOL_DYNAMIC_DEFAULT;
        if (nSporkID == SPORK_19_ENABLE_ZEROCOIN) r = SPORK_19_ENABLE_ZEROCOIN_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_18_NEW_PROTOCOL_DYNAMIC") return SPORK_18_NEW_PROTOCOL_DYNAMIC;
    if (strName == "SPORK_19_ENABLE_ZEROCOIN") return SPORK_19_ENABLE_ZEROCOIN;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_18_NEW_PROTOCOL_DYNAMIC) return "SPORK_18_NEW_PROTOCOL_DYNAMIC";
    if (id == SPORK_19_ENABLE_ZEROCOIN) return "SPORK_19_ENABLE_ZEROCOIN";
