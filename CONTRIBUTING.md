Contributing to Ittrium Core
============================

The Ittrium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ittrium Core project, and is not to be
confused with overall Ittrium Network Protocol consensus changes.

Whether a pull request is merged into Ittrium Core rests with the project merge
...
Patches that change Ittrium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ittrium consensus, it must have been
...
The project leader is the release manager for each Ittrium Core release.
