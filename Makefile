...
pkgdatadir = $(datadir)/ittrium
pkgincludedir = $(includedir)/ittrium
pkglibdir = $(libdir)/ittrium
pkglibexecdir = $(libexecdir)/ittrium
...
CONFIG_HEADER = $(top_builddir)/src/config/ittrium-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/ittrium-config.h.in \
...
ACLOCAL = ${SHELL} /home/ubuntu/BITG_XIT/BIT-XIT-working/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/ubuntu/BITG_XIT/BIT-XIT-working/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ubuntu/BITG_XIT/BIT-XIT-working/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ubuntu/BITG_XIT/BIT-XIT-working/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = ittrium-cli
BITCOIN_DAEMON_NAME = ittriumd
BITCOIN_GUI_NAME = ittrium-qt
BITCOIN_TX_NAME = ittrium-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/ubuntu/BITG_XIT/BIT-XIT-working/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = ittrium
PACKAGE_BUGREPORT = www.ittrium.io
PACKAGE_NAME = Ittrium Core
PACKAGE_STRING = Ittrium Core 1.0.0
PACKAGE_TARNAME = ittrium
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/ubuntu/BITG_XIT/BIT-XIT-working
abs_srcdir = /home/ubuntu/BITG_XIT/BIT-XIT-working
abs_top_builddir = /home/ubuntu/BITG_XIT/BIT-XIT-working
abs_top_srcdir = /home/ubuntu/BITG_XIT/BIT-XIT-working
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ubuntu/BITG_XIT/BIT-XIT-working/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_ittrium_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_ittrium_coverage.info test_ittrium.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Ittrium-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/ittrium-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/ittrium-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/ittrium-config.h
$(top_srcdir)/src/config/ittrium-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/ittrium-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Ittrium-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Ittrium-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Ittrium-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_ittrium.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_ittrium -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_ittrium_filtered.info: test_ittrium.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_ittrium_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_ittrium_coverage.info: baseline_filtered_combined.info test_ittrium_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_ittrium_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_ittrium_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_ittrium_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_ittrium.coverage/.dirstamp:  test_ittrium_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_ittrium.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_ittrium.coverage/ total.coverage/ $(OSX_APP)
